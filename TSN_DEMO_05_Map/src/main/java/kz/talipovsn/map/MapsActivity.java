...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    static final LatLng marker3 = new LatLng(52.273348, 76.947619); // маркер Достоевского
    static final LatLng marker4 = new LatLng(52.290380, 76.957300); // маркер Школы
    static final LatLng marker5 = new LatLng(52.285542, 76.938819); // маркер набережной
    static final LatLng marker6 = new LatLng(52.285775, 76.946187); // маркер площади победы
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(marker5).title((getString(R.string.marker5_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.naberejnaya)).alpha(ALPHA).
        ...
        mMap.addMarker(new MarkerOptions().position(marker6).title((getString(R.string.marker6_title))).icon(
                        BitmapDescriptorFactory.fromResource(R.drawable.ploshad)).alpha(ALPHA).
